                  ...
                  <div class="tab-content py-2">
                      ...
                      <div class="" id="general">
                        ...
                        <div class="form-group">
                          <div class="col-sm-5">
                            ...
                            {!! Form::text('emp_id',$employees->emp_id,['class'=>'form-control','id'=>'employeeId','readonly']) !!}
                          </div>
                          <div class="col-sm-5">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                      ...
                      <ul class="float-left">
                        ...
                        <li class="list-inline-item">
                          <button type="button" id="validateStep2" class="btn btn-primary next-step">Submit</button>
                        </li>
                      </ul>
                    </div>
                    <!-- Step3 -->
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function () {
        ...
        $(".next-step").click(function (e) {
          ...
          if((stepID=="validateStep1" && validateStep1(e)) || (stepID=="validateStep2" && validateStep2(e)) ){
            if(stepID=="validateStep2"){
