                      ...
                      <div class="" id="general">
                        ...
                        <div class="form-group">
                          <div class="col-sm-5">
                            ...
                            {!! Form::date('doj_date',$employees->emp_doj,['class'=>'form-control','id'=>'doj']) !!}
                          </div>
                      ...
                      <div class="" id="banck_account">
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            ...
                            <input type="text" class="form-control" name="esi" id="esi" value="{{old('esi',$employees->esi)}}">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-5">
                            <label for="hra">HRA</label>
                            <input type="text" class="form-control" name="hra" id="bankName" value="{{old('hra',$employees->hr)}}">
                          </div>
                          <div class="col-sm-5">
                            <label for="pf">PF</label>
                            <input type="text" class="form-control" name="pf" id="pf" value="{{old('pf',$employees->pf)}}">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-5">
                            <label for="da">DA</label>
                            <input type="text" class="form-control" name="da" id="da" value="{{old('da',$employees->da)}}">
                          </div>
                          <div class="col-sm-5">
                            <label for="Conveyance">Conveyance</label>
                            <input type="text" class="form-control" name="conveyance" id="Conveyance" value="{{old('conveyance',$employees->conveyance)}}">
                          </div>
                        </div>
                      </div>
                      <ul class="float-left">
