      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 action-controllers ">
            @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('brands','delete')) 
            ...
            @endif
            @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('brands','create')) 
                          ...
                          <td>
                            <div class="input-group-prepend">
                              ...
                              <ul class="dropdown-menu">
                                @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('brands','update')) 
