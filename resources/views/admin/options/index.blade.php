      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 action-controllers ">
            @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('option','delete')) 
            ...
            @endif
            @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('option','create')) 
                    ...
                    <tbody>
                    	@foreach ($product_options as $option)
                          ...
                          <td><i class="fas {{$published}}"></i></td>
                               ...
                               @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('option','update')) 
