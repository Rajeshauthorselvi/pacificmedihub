              ...
              <div class="card-body">
                {!! Form::open(['route'=>'delivery_zone.store','method'=>'POST','id'=>'zoneForm']) !!}
                  <div class="form-group clearfix">
                    ...
                    {{ Form::text('region_name',null,['class'=>'form-control','id'=>'region_name']) }}
                        ...
                        <table class="table table-bordered"> 
                          ...
                          <tbody id="tbody"> 
                            <tr id="R1" class="parent_tr"> 
                              ...
                              <td>
                                <input type="text" class="form-control" id="value" name="post_code[name][]" autocomplete="off" onkeyup="validateNum(event,this);" maxlength="6">
                              </td>
                              <td>
                                <div class="form-group">
