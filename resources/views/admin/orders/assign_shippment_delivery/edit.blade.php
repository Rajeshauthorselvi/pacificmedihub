...
@section('main_container')
    ...
    <section class="content">
                    ...
                    <div class="date-sec">
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          ...
                          {!! Form::select('order_status',$order_status, $order->order_status,['class'=>'form-control no-search ','id'=>'order_status']) !!}
                        </div>
                      </div>
                    </div>
      ...
      {{--                       <div class="col-sm-4">
                    ...
                    <div class="delivery-date">
                      <div class="form-group">
                      <?php $approximate_delivery_date=isset($order->approximate_delivery_date)?date('m/d/Y',strtotime($order->approximate_delivery_date)):date('d/m/Y'); ?>
                        <div class="col-sm-4">
  ...
  @push('custom-scripts')
    <script type="text/javascript">
      ...
      var $datepicker = $('.date-picker').datepicker({ minDate: 0,dateFormat: 'mm/dd/yy'});
