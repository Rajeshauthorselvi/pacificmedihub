			...
			<tr>
				...
				<td>
					<div class="form-group">
                        <input type="text" class="form-control base_price_row" id="{{$base_price_row_id}}" onkeyup="validateNum(event,this);" name="new_variant[{{ $vendor_id }}][base_price][]">
                    </div>
                </td>
                <td>
                	<div class="form-group">
                		<input type="text" class="form-control retail_price_row" id="{{$retail_price_row_id}}" onkeyup="validateNum(event,this);" name="new_variant[{{ $vendor_id }}][retail_price][]">
                	</div>
                </td>
                <td>
                	<div class="form-group">
                		<input type="text" class="form-control minimum_price_row" id="{{$minimum_price_row_id}}" onkeyup="validateNum(event,this);" name="new_variant[{{ $vendor_id }}][minimum_price][]">
                	</div>
                </td>
                <td>
                	<div class="form-group">
                		<input type="text" class="form-control stock_qty_row" id="{{$stock_qty_row_id}}" onkeyup="validateNum(event,this);" name="new_variant[{{ $vendor_id }}][stock_qty][]">
                	</div>
                </td>
                <td>
                	<div class="form-group">
