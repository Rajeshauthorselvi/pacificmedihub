      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 action-controllers ">
            @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('commission_setting','delete'))
            ...
            @endif
            @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('commission_setting','create'))
                        ...
                        <tr>
                          ...
                          <td>
                                <div class="input-group-prepend">
                                  ...
                                  @if (Auth::check() || Auth::guard('employee')->user()->isAuthorized('commission_setting','update'))
