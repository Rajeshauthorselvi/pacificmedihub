        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-outline card-primary">
              ...
              <div class="card-body">
                <form action="{{route('static-page.update',$page->id)}}" method="post" enctype="multipart/form-data" class="page-form">
                  @csrf 
                  <input name="_method" type="hidden" value="PATCH">
                  <div class="form-group">
                    <div class="col-sm-12">
                      <label for="pageTitle">Page Title *</label>
                      {!!Form::text('page_title',$page->page_title, ['class'=>'form-control','id'=>'pageTitle'])!!}
                      ...
                      <div class="adjoined-bottom">
                        <div class="grid-container">
                          <div class="grid-width-100">
                            <textarea id="editor" name="page_content">{{ $page->page_content }}</textarea>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-8">
                      ...
                      {!!Form::text('search_engine',$page->slug, ['class'=>'form-control','id'=>'searchEngine'])!!}
                    </div>
                    <div class="col-sm-2">
                      <label for="sortOrder">Sort by Order</label>
                      {!!Form::text('sort_order',$page->sort_by, ['class'=>'form-control','id'=>'sortOrder'])!!}
                    </div>
                    <div class="col-sm-2" style="margin-top:2.5rem">
                      <div class="icheck-info d-inline">
                        <input type="checkbox" name="published" id="published" @if((old('published')=='on')||($page->published==1)) checked @endif>
