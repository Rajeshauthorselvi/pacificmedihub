        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('products.index')}}">Static Pages</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-outline card-primary">
              ...
              <div class="card-body">
                <form action="{{route('static-page-slider.store')}}" method="post" enctype="multipart/form-data" id="bannerForm">
                  @csrf
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                      <label for="addBanner">Add Banner Images *</label>
                        ...
                        <table class="table table-bordered banner" id="bannerList"> 
                          ...
                          <tbody id="tbody"> 
                            <tr id="R1" class="parent_tr"> 
                              ...
                              <td>
                                <input type="file" class="form-control slider-image" name="slider_data[image][]" id="sliderImage" accept="image/*" onchange="preview_image(event,1,this.value);" style="display:none;" value="">
                                <img title="Click to Add" class="banner-img" id="output_image1"  onclick="$('#sliderImage').trigger('click'); return true;" src="{{ asset('theme/images/image_add.png')}}">
                              </td>
                              <td>
                                <input type="text" class="form-control" name="slider_data[display_order][]" onkeyup='validateNum(event,this);' value="1">
                              </td>
        ...
        $('#addBtn').on('click', function () { 
          $('#tbody:last').append(
            `<tr id="R${++rowIdx}" class="parent_tr">
              ...
              <td>
                <input type="file" class="form-control slider-image" name="slider_data[image][]" id="sliderImage${rowIdx}" accept="image/*" onchange="preview_image(event,${rowIdx},this.value)" style="display:none;" value="">
                <img title="Click to Add" class="banner-img" id="output_image${rowIdx}"  onclick="$('#sliderImage${rowIdx}').trigger('click'); return true;" src="{{ asset('theme/images/image_add.png')}}">
              </td>
              <td>
                <input type="text" class="form-control" name="slider_data[display_order][]" onkeyup='validateNum(event,this);' value="${rowIdx}">
              </td>
              <td class="text-center"> 
