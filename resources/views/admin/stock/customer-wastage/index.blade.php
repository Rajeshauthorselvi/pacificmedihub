  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Wastage List</h1>
          </div><!-- /.col -->
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
              <li class="breadcrumb-item">Customer Wastage</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    <tbody>
                      @foreach($returns as $return)
                        <tr>
                          ...
                          <td>{{ $return['damage_quantity'] }}</td>
                          <td class="text-center">
                            <a href="{{ route('customer-wastage.show',$return['return_id']) }}" class="btn btn-primary">
