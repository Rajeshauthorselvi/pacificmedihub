        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('low-stocks.index')}}">Purchase</a></li>
    ...
    <section class="content">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item active">
          <a href="{{route('low-stocks.index')}}"><i class="fas fa-angle-left"></i>&nbsp;Back</a>
        </li>
      </ol>
            ...
            <div class="card card-outline card-primary">
              ...
              <div class="card-body">
                <form action="{{route('purchase.store')}}" method="post" class="purchase-form">
                  ...
                  <div class="product-sec">
                    ...
                    {{--   <div class="col-sm-8">
                      ...
                      <div class="col-sm-4">
                        ...
                        {!! Form::select('vendor_id',$vendors, $selected_vendor,['class'=>'form-control vendors select2bs4','id'=>'vendorId']) !!}
                  ...
                  <div class="table-responsive vatiant_table">
                  <table class="table">
                  <thead class="heading-top">
                  <tr>
                  <td>#</td>
                  <th scope="col">Product Name</th>
                  <th>Total Quantity:&nbsp;<span class="all_quantity"></span></th>
                  <th>Total Amount:&nbsp;<span class="all_amount" id="allAmount"></span></th>
                  <th></th>
                  </tr>
                  </thead>
                  ...
                  <tr class="total-calculation"><td colspan="3" class="title">Total</td>
                  <td colspan="2"><span class="all_amount">0.00</span></td></tr>
                  <tr class="total-calculation"><td colspan="3" class="title">Order Discount</td>
                  <td colspan="2"><span class="order-discount">0.00</span></td></tr>
                  <tr class="total-calculation"><td colspan="3" class="title">Order Tax</td>
                  <td colspan="2" id="orderTax">0.00</td></tr>
                  <tr class="total-calculation"><th colspan="3" class="title">Total Amount(SGD)</th>
                  <th colspan="2" id="total_amount_sgd">0.00</th></tr>
                  ...
                  {!! Form::hidden('from','low_stock') !!}
                  <div class="col-sm-12 submit-sec">
                    <a href="{{ route('low-stocks.index') }}" class="btn  reset-btn">Cancel</a>
