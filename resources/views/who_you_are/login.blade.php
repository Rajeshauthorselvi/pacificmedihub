...
<head>
  ...
  <style type="text/css">
    .left-half{background:transparent url('theme/images/background_image/background.png') no-repeat center center/cover;position: fixed;top: 0px;left:0;width:50%;height: 100%}
