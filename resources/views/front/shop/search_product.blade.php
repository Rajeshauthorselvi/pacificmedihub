	      ...
	      <div class="category-page-wrapper">
	      	<div class="row">
		        <div class="col-md-6 list-grid-wrapper">
		          ...
		          <span class="tot-pro">{{ $products->total() }} Items</span> 
		      	</div>
	      	...
	      	<div class="row">
		      	@if(!empty($products) && $products->count())
			      	...
			      	@foreach($products as $product)
		                ...
		                $category = App\Models\Categories::where('id',$product->category_id)->first();
		                $category_slug = $category->search_engine_name;
